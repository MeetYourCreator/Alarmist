...
const CloclTextColorModal = ({iconName, onColorHandle}) => {
  ...
  const handleSet_E8E500 = () => {
    set_E8E500(_E8E500);
  };

  const handleSet_FF2281 = () => {
    set_FF2281(_FF2281);
  };

  const handleSet_75D5FD = () => {
    set_75D5FD(_75D5FD);
  };

  const handleSet_09FBD3 = () => {
    set_09FBD3(_09FBD3);
  };

  const handleSet_7122FA = () => {
    set_7122FA(_7122FA);
  };

  const handleSet_EF281E = () => {
    set_EF281E(_EF281E);
  };

  const handleSet_0000FF = () => {
    set_0000FF(_0000FF);
  };
  return (
...
export default CloclTextColorModal;
